function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
		'<li><a href="'+base+'minicolors_index.html">User Guide Home</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'installation/minicolors_index.html">Installation Instructions</a></li>' +
		...
		'<h3>Tutorial</h3>' +
		'<ul>' +
			'<li><a href="'+base+'tutorial/minicolors_index.html">Introduction</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'doc_style/minicolors_index.html">Writing Documentation</a></li>' +
		'</ul>' +
		...
		'<li><a href="'+base+'database/minicolors_index.html">Database Class</a></li>' +
		'<li><a href="'+base+'libraries/javascript.html">Javascript Class</a></li>' +
		'</ul>' +
